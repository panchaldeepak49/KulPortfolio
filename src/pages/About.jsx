...
const About = () => {
  ...
  return (
    ...
    <p data-aos="fade-down-right" className='mt-5 px-4 sm:px-8 text-white text-base sm:text-lg'>
    ...
    <p data-aos="fade-down-left" className='mt-5 px-4 sm:px-8 text-white text-base sm:text-lg'>
